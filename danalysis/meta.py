...
class LinearSystemMeta:
    '''Computes information required by the solver from a dimensional matrix and target dimensionality.'''
...
def info(dm: np.ndarray, q: np.ndarray) -> LinearSystemMeta:
    return LinearSystemMeta(dm, q)
