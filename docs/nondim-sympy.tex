...
\end{center}
Hence, you need to find relation $$t = f(l,m,g,\theta).$$ So, you plan to carry out experiments to study the value of $t$ for different values of the independent variables in all combinations. Assuming $N$ values per variable, requires you perform on the order of $N^4 = 10000$ experiments.
